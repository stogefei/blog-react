...
class Base extends Component {
    ...
    viewDetail(id) {
        ...
        // this.props.history.push({pathname:'/blogdetail',query: { id : id}})
                        ...
                        <div className="data-left">
                            ...
                            <ul>
                                {this.props.data.length ? this.props.data.map((item) => {
                                    return (
                                        <li className="data-item" key={item.id} onClick={this.viewDetail.bind(this, item.id)}>
                                            <div className="data-item-left">
                                                <div className="data-item-left-inner">
                                                    <h2 className="text-title text-color">{item.title}</h2>
                                                    <p className="data-item-detail summy-color">
                                                        {item.content}
                                                    </p>
                                                    <div className="text-info">
                                                        <p className="text-author">{item.author}</p>
                                                        {/*<p className="text-time">{item.createtime}</p>*/}
